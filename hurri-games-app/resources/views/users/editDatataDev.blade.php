                ...
                <form action="{{ route('users.registerDev', $user->id) }}" method="POST">
                    ...
                    <div class="user-details">
                        <div class="input-box">
                            ...
                            <input name="company_name" class="form-control"  type="text" value="{{$user->developerData()->company_name}}"/>
                        </div>

                        <div class="input-box">
                            <span class="details">Agência</span>
                            <input name="branch" class="form-control"  type="text" value="{{$user->developerData()->branch}}"/>
                        </div>

                        <div class="input-box">
                            <span class="details">Conta</span>
                            <input name="account" class="form-control" type="text" value="{{$user->developerData()->account}}"/>
                        </div>
